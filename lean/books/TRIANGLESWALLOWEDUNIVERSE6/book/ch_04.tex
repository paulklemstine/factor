...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig01_rectangle_dissection.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig02_gaussian_lattice.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig03_triple_factory.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig04_multiplication_table.png}
\caption*{Multiplication Table}
\end{figure}

\index{The Puzzle of the Two Squares}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig05_euler_xray.png}
\caption*{Euler Xray}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig06_euler_portrait.png}
\caption*{Euler Portrait}
\end{figure}

\index{A Factory for Pythagorean Triples}


Now watch how the curtain rises on a larger stage.

Hand me any two Pythagorean triples. I don't care which ones --- pick your favorites. I will combine them to produce a \textit{new} Pythagorean triple whose hypotenuse is the product of the two original hypotenuses. Every time, without fail.\index{Pythagorean triple}
...
The elegance here is almost unreasonable. The composition of Pythagorean triples is not some ad hoc construction --- it is multiplication of Gaussian integers in disguise. The triple $(a, b, c)$ corresponds to the Gaussian integer $a + bi$ with norm $c$. Composing two triples is just multiplying the corresponding Gaussian integers and reading off the new legs from the real and imaginary parts. Gauss understood this in the early 1800s, and it led him to one of the most beautiful theorems in number theory: a prime $p$ can be written as the sum of two squares if and only if $p = 2$ or $p \equiv 1 \pmod{4}$.\index{Gauss, Carl Friedrich}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig07_pythagorean_cone.png}
\caption*{Pythagorean Cone}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig08_light_cones.png}
\caption*{Light Cones}
\end{figure}
...
This observation belongs to Euler, who spent decades wrestling with the arithmetic of sums of squares. His correspondence with Goldbach, stretching from 1730 to 1764, is one of the great mathematical dialogues of the eighteenth century, and sums of squares were a recurring theme. Fermat had claimed, without proof, that every prime of the form $4k + 1$ is a sum of two squares. Euler was determined to prove it --- and along the way, he discovered a factoring method of surprising beauty.\index{Fermat, Pierre de}
...
Now compute $\gcd(a - c, d - b)$ and $\gcd(a + c, d + b)$. With a bit of careful arithmetic, at least one of these GCDs will share a non-trivial common factor with $N$, splitting it open.\index{greatest common divisor}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig09_berggren_tree.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig10_tree_sieve.png}
\caption*{Tree Sieve}
\end{figure}

\index{The Lorentz Form --- When Pythagoras Meets Einstein}


What could the ancient theorem about right triangles have in common with Einstein's special relativity?\index{Einstein, Albert}

The answer is a single expression with a minus sign in it:

\[Q(a, b, c) = a^2 + b^2 - c^2.\]

We met this quadratic form in Chapter 1 --- the \textit{Lorentz form}. A Pythagorean triple is nothing more than an integer point where $Q$ vanishes. The surface $Q = 0$ is a cone in three-dimensional space, and the Pythagorean triples are the lattice points scattered across its surface like stars on a celestial sphere.\index{Lorentz group}
...
The magic of these transformations is that they preserve $Q$. If $Q(a, b, c) = 0$, then $Q(B_i(a, b, c)) = 0$ for $i = 1, 2, 3$. This is the \textbf{Lorentz Invariance Theorem}, and it is the reason the Berggren tree works: every child of a Pythagorean triple is itself Pythagorean.\index{Berggren tree}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig11_divisor_arcs.png}
\caption*{Divisor Arcs}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig12_three_roads_map.png}
\caption*{Three Roads Map}
\end{figure}

\index{The Berggren Tree --- An Infinite Family Album}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig13_exponential_climb.png}
\caption*{Exponential Climb}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig14_flower_diagram.png}
\caption*{Flower Diagram}
\end{figure}

\index{The Tree Sieve --- Shaking the Family Tree for Factors}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig15_factoring_toolkit.png}
\caption*{Factoring Toolkit}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter4/images/fig16_road_ahead.png}
\caption*{Road Ahead}
\end{figure}

\index{Semiprime Secrets --- Why N = p times q Is Special}
...
\index{The Exponential Climb --- How Fast the Tree Grows}
...
\index{The Hidden Arithmetic of Products}
...
\index{The Three Roads Converge --- A Factoring Toolkit}
...
\textit{(Hint: Start by noticing that $5{,}525 = 5 \times 1{,}105$, and recall what we learned about $1{,}105$ earlier in this chapter…)}
