\chapter{The GCD Cascade: Cracking Numbers Open with Pythagorean Channels}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig01_eavesdropper.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig02_channel_tetrahedron.png}
\caption*{Channel Tetrahedron}
\end{figure}

\index{The Eavesdropper's Puzzle}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig03_triangulation_venn.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig04_cascade_waterfall.png}
...
Each channel has a twin identity. Since $a^2 + b^2 + c^2 = d^2$, we may subtract one squared leg from both sides and discover that every channel is also a \textit{difference of squares} involving the hypotenuse:\index{difference of squares}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig05_composite_tower.png}
\caption*{Composite Tower}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig06_parity_chessboard.png}
\caption*{Parity Chessboard}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig07_three_trails.png}
\caption*{Three Trails}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig08_brahmagupta.png}
\caption*{Brahmagupta}
\end{figure}

\index{The Prime Cascade}
...
You can --- and the guarantee is as old as Euclid. Book VII of the \textit{Elements}, Proposition 30, states that if a prime divides a product, it must divide one of the factors. In modern dress:\index{Euclid}
...
Euclid stated his lemma around 300 BCE. For more than two millennia, mathematicians regarded it as a tidy observation about primes. They had no idea it was a \textit{factoring engine}.\index{factoring}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig09_asymmetry.png}
\caption*{Asymmetry}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig10_descent_spheres.png}
\caption*{Descent Spheres}
\end{figure}

\index{The Composite Tower}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig11_pell_staircase.png}
\caption*{Pell Staircase}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig12_channel_graphs.png}
\caption*{Channel Graphs}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig13_modular_fingerprint.png}
\caption*{Modular Fingerprint}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter13/images/fig14_gcd_flowchart.png}
\caption*{Gcd Flowchart}
\end{figure}
...
In the seventh century, the Indian mathematician Brahmagupta discovered an identity so useful that it ought to be printed on the back of every business card in number theory.\index{Brahmagupta--Fibonacci identity}
...
Pierre de Fermat's favorite trick was \textit{infinite descent}: prove that if a solution exists, a smaller one must also exist, and then a still smaller one, and so on --- until you reach an impossibility. What if we turn descent into a \textit{tool} rather than a contradiction?\index{Fermat, Pierre de}
...
\index{The Balanced Quadruple That Doesn't Exist}
...
The method is not guaranteed to succeed with a single quadruple --- it is possible, though rare, for all six small factors to be coprime to $d$. But with multiple representations, the probability of detection compounds. And the cascade ensures that even a single detected prime propagates through the entire structure, exposing all the factors of $d$ in a chain reaction of divisibility.\index{coprimality}
