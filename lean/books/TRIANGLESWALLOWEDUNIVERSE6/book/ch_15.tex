\chapter{The Algebra Where Two Plus Three Equals Two: Tropical Geometry and the Shortest-Path Semiring}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig01_tropical_calculator.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig02_distributive_shift.png}
\caption*{Distributive Shift}
\end{figure}

\index{The Calculator That Forgot How to Add}
...
satisfies every axiom of a semiring. Tropical addition is commutative, because the smaller of $a$ and $b$ is the smaller of $b$ and $a$:\index{tropical geometry}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig03_totem_pole.png}
\caption*{Totem Pole}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig04_newton_polygon.png}
\caption*{Newton Polygon}
\end{figure}

\index{A Distributive Law That Actually Works}
...
Why does this hold universally? Because shifting two numbers by the same amount $a$ does not change which is smaller. If $b < c$, then $a + b < a + c$, so $\min(a + b,\, a + c) = a + b = a + \min(b,c)$. The argument for $b \ge c$ is symmetric.\index{RSA cryptosystem}


So our broken calculator is a genuine \textit{semiring} --- it obeys every axiom of a ring except one: tropical addition has no inverses. You can take a minimum, but you cannot "un-take" it. Once the smaller number wins, the larger is forgotten. This asymmetry will haunt us for the rest of the chapter.\index{semiring}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig05_convex_hulls.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig06_triangle_inequality.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig07_tropical_matrix.png}
\caption*{Tropical Matrix}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig08_bellman_ford.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig09_book_map.png}
\caption*{Book Map}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter15/images/fig10_tropical_polynomial.png}
\caption*{Tropical Polynomial}
\end{figure}

\index{The Tropical Convex Hull, or: The Winner Never Loses}
...
\index{The Triangle Inequality in a World Without Triangles}
...
\index{The Traveling Salesman's Secret Algebra}
