\chapter{The Fourth Dimension of Pythagoras: How Quadruples Crack Numbers}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig01_quadruple_table.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig02_triangle_to_sphere.png}
\caption*{Triangle To Sphere}
\end{figure}

\index{1. A Puzzle in Four Parts}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig03_bridge.png}
\caption*{Bridge}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig04_quadruple_machine.png}
\caption*{Quadruple Machine}
\end{figure}

\index{2. The Magician's Bridge}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig05_hypotenuse_decomposition.png}
\caption*{Hypotenuse Decomposition}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig06_collision_roads.png}
\caption*{Collision Roads}
\end{figure}

\index{3. The Master Key}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig07_scaling_tetrahedra.png}
\caption*{Scaling Tetrahedra}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig08_lattice_sphere.png}
\caption*{Lattice Sphere}
\end{figure}

\index{4. The Collision Detector}
...
For our pair with $d = 9$: $(8 - 7)(8 + 7) = 1 \times 15 = 15$. And $(16 - 1) + (16 - 16) = 15$. Check. Now compute $\gcd(15, 81) = 3$ --- and we have extracted a factor of $81 = 3^4$.\index{greatest common divisor}

The word "collision" is deliberate: this is the same principle behind \textit{birthday attacks} in cryptography. Finding two representations of the same number as a sum of three squares is the number-theoretic analogue of finding a hash collision --- and just as devastating.\index{cryptography}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig09_gaussian_plane.png}
\caption*{Gaussian Plane}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig10_euclid_lever.png}
\caption*{Euclid Lever}
\end{figure}

\index{5. Stretching the Quadruple}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig11_mod4_grid.png}
\caption*{Mod4 Grid}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{../Chapter12/images/fig12_workbench.png}
\caption*{Workbench}
\end{figure}

\index{6. The Lattice Detective}
...
This is the \textbf{Lattice Pair Identity} --- the "cross-examination" of two witnesses who both claim to have seen the number $d^2$. Their testimony must be \textit{consistent}, and the consistency condition encodes factoring information in the cross-differences.\index{lattice}
...
Euclid knew the answer twenty-three centuries ago: if $p$ is prime and $p$ divides a product, then $p$ must divide at least one of the factors. This is \textbf{Euclid's Lemma} --- the oldest and sharpest lever in number theory. Applied to our Pythagorean bridge, it becomes a factoring crowbar.\index{Euclid}
...
A worked example: the quadruple $(2, 3, 6, 7)$ gives $a^2 + b^2 = 13$, which is prime. So $13 \mid (7 - 6) = 1$ or $13 \mid (7 + 6) = 13$. The latter holds. Now $\gcd(13, 7) = 1$, confirming that $7$ is coprime to $13$ --- consistent with $7$ being prime.\index{coprimality}
...
\index{10. The Number Cruncher's Workbench}
...
4. Prove that no Pythagorean quadruple with $a = b = c$ can have $d$ prime. \textit{(Hint: consider the equation modulo $3$.)}
...
8. \textit{(Open)} Is there an efficient algorithm to enumerate all primitive Pythagorean quadruples with hypotenuse $d$ in time polynomial in $\log d$?\index{Pythagorean triple!primitive}
