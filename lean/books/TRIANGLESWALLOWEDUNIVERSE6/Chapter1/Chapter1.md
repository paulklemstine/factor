...
[ILLUSTRATION: A schematic matrix-times-vector calculation showing $\mathbf{A} \cdot (3, 4, 5)^\top = (5, 12, 13)^\top$, with each row's dot product written out step by step: $1(3) + (-2)(4) + 2(5) = 5$, $2(3) + (-1)(4) + 2(5) = 12$, $2(3) + (-2)(4) + 3(5) = 13$.]
