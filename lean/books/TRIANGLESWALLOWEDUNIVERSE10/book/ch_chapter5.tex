...
\begin{quote}
\textit{How many primitive Pythagorean triples\index{Pythagorean triple} can this tree reach?}
\end{quote}

The answer --- proved by a Swedish schoolteacher named B. Berggren\index{Berggren, B.} in 1934, forgotten, and independently rediscovered by F. J. M. Barning in 1963 and by A. Hall in 1970 --- is: \textbf{all of them}. Every primitive Pythagorean triple appears exactly once in the tree. No omissions, no repetitions. The entire infinite catalogue of right triangles with coprime\index{coprimality} integer sides hangs from the branches of a single $(3, 4, 5)$.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig01_berggren_tree.png}
\caption{A full ternary tree diagram, three levels deep, rooted at $(3,4,5)$.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig02_three_triangles.png}
\caption{Three right triangles drawn to scale: $(3,4,5)$, $(5,12,13)$, and $(15,8,17)$.}
\end{figure}
...
\textbf{Theorem (Lorentz\index{Lorentz, Hendrik} Form Preservation).} Let $\eta$ denote the diagonal matrix
...
Compute the determinant\index{determinant}s:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig05_mirror_triangle.png}
\caption{Two versions of a right triangle $(3,4,5)$, one the mirror image of the other (reflected across a vertical axis).}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig06_pythagorean_check.png}
\caption{A segment of the Berggren tree (3 levels deep), with each node's triple displayed inside a circle.}
\end{figure}
...
In Einstein's universe, light travels along surfaces where "distance" equals zero. Not the Euclid\index{Euclid}ean distance --- that is always positive --- but the \textit{spacetime\index{spacetime} interval}, the quantity $x^2 + y^2 - (ct)^2$ where $c$ is the speed of light (not our hypotenuse, for once). The surfaces where this interval vanishes form a cone in spacetime, and this cone --- the \textit{null cone}, or \textit{light cone} --- is the most important geometric object in all of physics. It separates the events you can influence from the events you cannot.

In the universe of Pythagorean triples, every triple lives on precisely the same kind of surface. The equation $a^2 + b^2 - c^2 = 0$ defines the null cone of the Lorentz form $Q$. This is not a metaphor or a loose analogy --- it is exactly the same algebraic condition, the same quadratic form\index{quadratic form}, the same cone. Only the physical interpretation differs.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig07_null_cone_regions.png}
\caption{The null cone $a^2 + b^2 = c^2$ in 3D, shown with the interior (timelike region, $Q < 0$) shaded in cool blue and the exterior (spacelike region, $Q > 0$) shaded in warm gold.}
\end{figure}
...
The proof is one line: $c^2 - b^2 = a^2$ is just a rearrangement of $a^2 + b^2 = c^2$. The left-hand side is a difference of squares\index{difference of squares}; the right-hand side is a perfect square. Elementary, yes --- but the implications are anything but.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig08_factoring_vice.png}
\caption{A "factoring vice" diagram.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig09_brahmagupta_fibonacci.png}
\caption{A visual proof of the Brahmagupta–Fibonacci identity using a rectangle subdivided into squares.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig10_euclid_grid.png}
\caption{A grid of dots representing integer pairs $(m, n)$ with $m > n > 0$, arranged with $m$ on the horizontal axis and $n$ on the vertical.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig11_a_staircase.png}
\caption{A vertical staircase drawn in side view (like an architectural cross-section), each step labeled with a Pythagorean triple.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig12_pell_number_line.png}
\caption{A number line (logarithmic scale) showing the B-branch hypotenuses $5, 29, 169, 985, 5741$ at exponentially increasing intervals.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig13_b_branch_vine.png}
\caption{A single vertical "branch" of the Berggren tree --- the pure $B$-path, rendered as a vine growing upward.}
\end{figure}
...
the capstone that connects the multiplicative structure of sums of squares to Gauss\index{Gauss, Carl Friedrich}ian integer norms --- $|z_1 z_2|^2 = |z_1|^2 |z_2|^2$ --- and explains why the factoring identity has teeth: if $N^2$ is a sum of two squares in multiple ways, each representation gives a shot at a factor.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig14_grand_mosaic.png}
\caption{A large, ornate diagram --- the "Grand Mosaic." At the center, a Pythagorean triple $(a, b, c)$ inscribed in a glowing right triangle.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter5_fig15_cheat_sheet.png}
\caption{A full-page "cheat sheet" showing all eight theorem statements in clean mathematical typesetting, each numbered and titled.}
\end{figure}
