...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig01_rope_triangle.png}
\caption{A coiled rope with 12 equally-spaced colored knots, stretched taut into a 3-4-5 right triangle on a sandy background.}
\end{figure}
...
\begin{quote}
\textit{Is there a master list of every Pythagorean triple\index{Pythagorean triple} with no common factor --- every "primitive" one? And if so, how long is it?}
\end{quote}
...
But first, a few familiar faces. Here are the primitive Pythagorean triples\index{Pythagorean triple} with hypotenuse less than 50, sorted for your convenience:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig02_null_cone.png}
...
In plain language: the mirror preserves the Lorentz\index{Lorentz, Hendrik} form. If $Q(\mathbf{v}) = 0$ --- if the input lies on the null cone --- then $Q(\mathbf{M}\mathbf{v}) = \mathbf{v}^\top \mathbf{M}^\top \mathbf{Q}\, \mathbf{M}\, \mathbf{v} = \mathbf{v}^\top \mathbf{Q}\, \mathbf{v} = 0$. The output lies on the cone too. \textit{The mirrors preserve the shape of nothing.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig04_matrix_vector.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig05_berggren_tree.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig06_descent_maze.png}
\caption{A maze shaped like an inverted tree.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig07_factoring_trick.png}
\caption{A visual "magic trick" layout.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig08_gnomon.png}
\caption{A conceptual diagram showing the algebraic identity geometrically.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig09_b_branch.png}
\caption{A number line or exponential growth chart showing the B-branch hypotenuses $5, 29, 169, 985, 5741, \ldots$ spaced on a logarithmic scale.}
\end{figure}
...
Euclid's engine interacts beautifully with the Berggren tree\index{Berggren tree}. Consider the triples generated by \textit{consecutive} parameters, $n = m - 1$:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig10_euclid_grid.png}
\caption{A two-dimensional grid with axes labeled $m$ and $n$.}
\end{figure}
...
In 1905, Einstein showed that the laws of physics are unchanged by Lorentz transformations --- symmetries that mix space and time while preserving the quadratic form\index{quadratic form} $x^2 + y^2 - t^2$. Now look at what we have been doing all chapter: the Berggren matrices preserve $a^2 + b^2 - c^2$. They are Lorentz transformations --- integer ones.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig11_poincare_disk.png}
\caption{The Poincaré disk, shown as a circle.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig12_light_cones.png}
...
\textbf{Wonder 5 --- Lorentz Symmetry.} The three Berggren matrices generate a subgroup of the integer Lorentz group\index{Lorentz group} $O(2,1;\mathbb{Z})$, and the tree is its Cayley graph, tiling the hyperbolic plane.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter1_fig13_wonder_map.png}
\caption{A full-page "wonder map" --- a stylized infographic.}
\end{figure}
