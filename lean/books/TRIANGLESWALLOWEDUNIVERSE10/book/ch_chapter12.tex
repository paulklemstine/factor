...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig01_quadruple_table.png}
\caption{A beautifully arranged table of the first fifteen primitive Pythagorean quadruples (those with $\gcd(a,b,c,d)=1$), sorted by $d$, displayed inside a stylised four-dimensional hypercube wireframe.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig02_triangle_to_sphere.png}
\caption{Side-by-side comparison.}
\end{figure}


Euler\index{Euler, Leonhard} studied sums of three squares; Jacobi counted the number of representations with exquisite generating-function machinery; Lagrange proved that every positive integer is a sum of four squares. The Pythagorean quadruple sits at the crossroads of these classical investigations. But it also harbours a secret that none of the old masters fully exploited: it is a \textit{factoring tool}. And that is what the rest of this chapter is about.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig03_bridge.png}
\caption{A stone arch bridge spanning a river.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig04_quadruple_machine.png}
\caption{A vintage brass-and-mahogany mechanical device with four labelled input dials ($m$, $n$, $p$, $q$) on the left and four output displays ($a$, $b$, $c$, $d$) on the right.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig05_hypotenuse_decomposition.png}
\caption{A number-line diagram showing $d$ as a single segment, decomposed into two coloured sub-segments: $m^2 + n^2$ (shaded blue) and $p^2 + q^2$ (shaded red).}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig06_collision_roads.png}
\caption{Two winding roads on a hilly landscape, each starting from a different village, converge on the same hilltop labelled $d^2 = 81$.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig07_scaling_tetrahedra.png}
\caption{A small tetrahedron with vertices labelled $(1, 2, 2, 3)$ sits beside a geometrically similar but three-times-larger tetrahedron labelled $(3, 6, 6, 9)$.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig08_lattice_sphere.png}
\caption{A three-dimensional integer lattice (a grid of dots in space) with a translucent sphere of radius $d$ centred at the origin.}
\end{figure}
...
What does this have to do with Pythagorean quadruples? Everything. The \textbf{norm} of a Gauss\index{Gauss, Carl Friedrich}ian integer $z = a + bi$ is defined as
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig09_gaussian_plane.png}
\caption{The complex plane with an integer grid.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig10_euclid_lever.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig11_mod4_grid.png}
\caption{A $4 \times 4$ grid where rows represent values of $a^2 \bmod 4$ (labelled $0$ and $1$, repeating) and columns represent $b^2 \bmod 4$.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig12_workbench.png}
\caption{A mathematician's workbench scene.}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{images/chapter12_fig13_histogram.png}
\caption{A histogram (bar chart) showing the number of primitive Pythagorean quadruples for each value of $d$ from $1$ to $50$.}
\end{figure}
