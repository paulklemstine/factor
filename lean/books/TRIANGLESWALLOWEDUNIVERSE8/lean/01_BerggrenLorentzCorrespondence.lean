...
integer Lorentz group O(2,1;ℤ), tiling the hyperbolic plane.
-/
...
example : (667 : ℤ) ^ 2 + 156 ^ 2 = 685 ^ 2 := by norm_num

/-- The factoring identity applied: (685-156)(685+156) = 529 × 841 = 667² -/
example : (685 - 156) * (685 + 156) = (667 : ℤ) ^ 2 := by norm_num

/-- 529 = 23² and 841 = 29², revealing 667 = 23 × 29 -/
example : (529 : ℤ) = 23 ^ 2 := by norm_num
example : (841 : ℤ) = 29 ^ 2 := by norm_num
example : (667 : ℤ) = 23 * 29 := by norm_num
