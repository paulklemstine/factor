\chapter{\textit{The Tree That Knew It Was a Spacetime}}
\begin{center}\large\itshape \textit{How Three Matrices, a Quadratic Form, and a Pell Equation Reveal That Pythagorean Triples Live in Einstein's Universe}\end{center}
\medskip
\label{ch05}
...
\begin{quote}
\itshape \textit{How many primitive Pythagorean triples can this tree reach?}
\end{quote}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig01_berggren_tree.png}
\caption{A full ternary tree diagram, three levels deep, rooted at $(3,4,5)$. Each node is a circle containing a Pythagorean triple $(a, b, c)$. The three downward branches from each node are labeled $A$, $B$\ldots}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig02_three_triangles.png}
\caption{Three right triangles drawn to scale: $(3,4,5)$, $(5,12,13)$, and $(15,8,17)$. Each triangle's sides are clearly labeled with lengths. Arrows indicate which Berggren matrix maps one triangle to the\ldots}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig03_null_cone.png}
\caption{A three-dimensional coordinate system with axes labeled $a$, $b$, $c$. A cone (the "light cone") is drawn satisfying $a^2 + b^2 = c^2$, i.e., $Q = 0$. The cone opens upward along the $c$-axis.\ldots}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig04_spacetime_comparison.png}
\caption{Side-by-side comparison. LEFT: A classic spacetime diagram from physics, showing a light cone with two worldlines --- one timelike (inside the cone) and one spacelike (outside). The axes are labeled\ldots}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig05_mirror_triangle.png}
\caption{Two versions of a right triangle $(3,4,5)$, one the mirror image of the other (reflected across a vertical axis). The left triangle is labeled "proper" ($\det = +1$), the right is labeled "improper"\ldots}
\end{figure}
...
\begin{enumerate}
\item \textbf{Base case.} The root is $(3, 4, 5)$. Check: $9 + 16 = 25$. \ensuremath{\checkmark}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig06_pythagorean_check.png}
\caption{A segment of the Berggren tree (3 levels deep), with each node's triple displayed inside a circle. Alongside each triple, the values $a^2 + b^2$ and $c^2$ are computed explicitly, demonstrating\ldots}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig07_null_cone_regions.png}
\caption{The null cone $a^2 + b^2 = c^2$ in 3D, shown with the interior (timelike region, $Q < 0$) shaded in cool blue and the exterior (spacelike region, $Q > 0$) shaded in warm gold. The cone's surface\ldots}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig08_factoring_vice.png}
\caption{A "factoring vice" diagram. A large number $N^2$ sits in the center, rendered as a heavy block. Two arrows labeled $c - b$ and $c + b$ press in from both sides like the jaws of a vice, splitting the\ldots}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig09_brahmagupta_fibonacci.png}
\caption{A visual proof of the Brahmagupta--Fibonacci identity using a rectangle subdivided into squares. A large rectangle has area $(a_1^2 + b_1^2)(a_2^2 + b_2^2)$. Through a clever geometric rearrangement ---\ldots}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig11_a_staircase.png}
\caption{A vertical staircase drawn in side view (like an architectural cross-section), each step labeled with a Pythagorean triple. At the bottom: $(3, 4, 5)$ with label $(m,n) = (2,1)$. Above it:\ldots}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig12_pell_number_line.png}
\caption{A number line (logarithmic scale) showing the B-branch hypotenuses $5, 29, 169, 985, 5741$ at exponentially increasing intervals. Curved arrows between consecutive terms, labeled\ldots}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig13_b_branch_vine.png}
\caption{A single vertical "branch" of the Berggren tree --- the pure $B$-path, rendered as a vine growing upward. At each node (rendered as a leaf), the full triple $(a_n, b_n, c_n)$ is listed. Beside each\ldots}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig14_grand_mosaic.png}
\caption{A large, ornate diagram --- the "Grand Mosaic." At the center, a Pythagorean triple $(a, b, c)$ inscribed in a glowing right triangle. Radiating outward in eight directions, like the points of a\ldots}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter5/images/fig15_cheat_sheet.png}
\caption{A full-page "cheat sheet" showing all eight theorem statements in clean mathematical typesetting, each numbered and titled. The layout is two columns, with generous whitespace and classical serif\ldots}
\end{figure}
