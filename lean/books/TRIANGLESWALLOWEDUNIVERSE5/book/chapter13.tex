...
\section{The Eavesdropper's Puzzle}\label{ch13-the-eavesdroppers-puzzle}
...
\section{Three Channels, One Tower}\label{ch13-three-channels-one-tower}
...
\section{Cross-Channel Eavesdropping}\label{ch13-cross-channel-eavesdropping}
...
\section{The Prime Cascade}\label{ch13-the-prime-cascade}
...
\section{The Composite Tower}\label{ch13-the-composite-tower}
...
\section{Even, Odd, and the Rule of Four}\label{ch13-even-odd-and-the-rule-of-four}
...
\section{Many Witnesses, One Peak}\label{ch13-many-witnesses-one-peak}
...
\section{Brahmagupta's Ancient Trick}\label{ch13-brahmaguptas-ancient-trick}
...
\section{The Factor Detective}\label{ch13-the-factor-detective}
...
\section{Infinite Descent Among the Quadruples}\label{ch13-infinite-descent-among-the-quadruples}
...
\section{The Balanced Quadruple That Doesn't Exist}\label{ch13-the-balanced-quadruple-that-doesnt-exist}
...
This tiny proof --- three lines, barely a paragraph --- conceals a deep principle. The irrationality of \(\sqrt{3}\) follows from the fact that \(3\) is prime, which prevents \(3a^2 = d^2\) from having a solution (since \(3\) would have to divide \(d\), say \(d = 3d'\), giving \(a^2 = 3d'^2\), which forces \(3 \mid a\), say \(a = 3a'\), giving \(3a'^2 = d'^2\) --- \index{infinite descent}infinite descent again, with no base case).
...
\section{Higher Dimensions, Higher Channels}\label{ch13-higher-dimensions-higher-channels}
...
\section{Fingerprints and Sieves}\label{ch13-fingerprints-and-sieves}
...
\section{Putting It All Together}\label{ch13-putting-it-all-together}
