...
\section{A Puzzle for the Pharaohs}\label{ch1-a-puzzle-for-the-pharaohs}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig01_rope_triangle.png}
\end{figure}
...
But first, a few familiar faces. Here are the primitive \index{Pythagorean triple}Pythagorean triples with hypotenuse less than 50, sorted for your convenience:
...
\section{The Shape of Nothing}\label{ch1-the-shape-of-nothing}
...
The function \(Q\) has a name that may surprise you. Physicists call it a \emph{Lorentz \index{quadratic form}quadratic form} --- the very same mathematical creature that governs the geometry of spacetime in Einstein's \index{special relativity}special relativity. In that theory, the ``distance'' between two events is measured not by \(x^2 + y^2 + t^2\) but by \(x^2 + y^2 - t^2\), with a crucial minus sign in front of the time coordinate. The surfaces where this quantity equals zero form a \emph{cone} --- the famous light cone, the boundary between the reachable future and the inaccessible elsewhere.


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig02_null_cone.png}
\end{figure}


Our Pythagorean triples are exactly the \emph{integer points on the \index{null cone}null cone} --- the lattice points where \(Q\) vanishes. If we write \(Q\) in matrix language,
...
\section{Three Magic Mirrors}\label{ch1-three-magic-mirrors}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig03_magic_mirrors.png}
\end{figure}
...
In plain language: the mirror preserves the \index{Lorentz form}Lorentz form. If \(Q(\mathbf{v}) = 0\) --- if the input lies on the null cone --- then \(Q(\mathbf{M}\mathbf{v}) = \mathbf{v}^\top \mathbf{M}^\top \mathbf{Q}\, \mathbf{M}\, \mathbf{v} = \mathbf{v}^\top \mathbf{Q}\, \mathbf{v} = 0\). The output lies on the cone too. \emph{The mirrors preserve the shape of nothing.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig04_matrix_vector.png}
\end{figure}




\section{An Infinite Family Tree}\label{ch1-an-infinite-family-tree}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig05_berggren_tree.png}
\end{figure}
...
\section{Climbing Down the Tree}\label{ch1-climbing-down-the-tree}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig06_descent_maze.png}
\end{figure}


This is a descent argument --- a technique with a glorious pedigree stretching back to Fermat himself, who used ``\index{infinite descent}infinite descent'' to prove that \(x^4 + y^4 = z^2\) has no positive integer solutions. The idea is always the same: if a counterexample existed, you could construct a smaller one, then a smaller one still, then a smaller one again\ldots{} but positive integers cannot decrease forever. Contradiction.



\section{Cracking Numbers with Triangles}\label{ch1-cracking-numbers-with-triangles}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig07_factoring_trick.png}
\end{figure}


This is no mere parlor trick. The factoring identity \((c-b)(c+b) = a^2\) is intimately related to Fermat's classical method of factoring by difference of squares. What the \index{Berggren tree}Berggren tree adds is \emph{structure}: instead of searching blindly for a representation \(N^2 = c^2 - b^2\), you can walk the tree looking for triples where \(a\) is a multiple of \(N\). The tree provides a map of the territory.


\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig08_gnomon.png}
\end{figure}




\section{The Fast Lane}\label{ch1-the-fast-lane}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig09_b_branch.png}
\end{figure}




\section{Euclid's Ancient Engine}\label{ch1-euclids-ancient-engine}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig10_euclid_grid.png}
\end{figure}




\section{Spacetime Symmetry in Whole Numbers}\label{ch1-spacetime-symmetry-in-whole-numbers}
...
the \emph{integer \index{Lorentz group}Lorentz group}. Matrices with determinant \(+1\) (like \(\mathbf{A}\) and \(\mathbf{C}\)) are \emph{proper} Lorentz transformations --- orientation-preserving rotations of the null cone. Matrix \(\mathbf{B}\), with determinant \(-1\), includes a reflection; it is \emph{improper}.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig11_poincare_disk.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig12_light_cones.png}
\end{figure}




\section{The Five Wonders}\label{ch1-the-five-wonders}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Chapter1/images/fig13_wonder_map.png}
\end{figure}
...
\section{Puzzles for the Reader}\label{ch1-puzzles-for-the-reader}
