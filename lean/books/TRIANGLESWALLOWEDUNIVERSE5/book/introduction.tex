\section{Section 1: The Puzzle on the Bathroom Tiles}\label{intro-section-1-the-puzzle-on-the-bathroom-tiles}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Introduction/images/fig01_pythagorean_squares.png}
\end{figure}
...
\section{A Four-Thousand-Year-Old Secret}\label{intro-a-four-thousand-year-old-secret}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Introduction/images/fig02_primitive_triples_table.png}
\end{figure}


Since we can choose \(m\) and \(n\) to be as large as we please, the formula generates infinitely many triples. The bathroom tiles never run out. But a new question immediately surfaces: does this formula generate \emph{all} \index{Pythagorean triple}Pythagorean triples, or only some of them? And among the triples it generates, are there repetitions --- different choices of \((m, n)\) that happen to produce the same triple?
...
\section{Primitive vs.~Imprimitive: The Genealogy of Triples}\label{intro-primitive-vs.-imprimitive-the-genealogy-of-triples}
...
\section{The Question That Drives This Book}\label{intro-the-question-that-drives-this-book}
...
That connection --- the connection between a \(3\)-\(4\)-\(5\) triangle and Einstein's theory of \index{special relativity}special relativity --- is the secret heart of this book. And we will reach it, step by step, through a succession of puzzles, surprises, and mathematical revelations that begin right here on the bathroom floor.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../Introduction/images/fig03_bathroom_scene.png}
\end{figure}
