...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig01_rope_triangle.png}
\captionof{figure}{A coiled rope with 12 equally-spaced colored knots, stretched taut into a 3-4-5 right triangle on a sandy background. The right angle is marked with a small squ}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig02_null_cone.png}
\captionof{figure}{A three-dimensional coordinate system with axes labeled $a$, $b$, $c$. A double cone (the "null cone") opens along the $c$-axis; its surface is defined by }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig03_magic_mirrors.png}
\captionof{figure}{Three ornate hand mirrors arranged in a fan. Each mirror's glass shows a transformation: the left mirror ($\mathbf{A}$) reflects $(3,4,5)$ into $(5,12,13)$; the}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig04_matrix_vector.png}
\captionof{figure}{A schematic matrix-times-vector calculation showing $\mathbf{A} \cdot (3, 4, 5)^\top = (5, 12, 13)^\top$, with each row's dot product written out step by step: }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig05_berggren_tree.png}
\captionof{figure}{A large, beautifully rendered ternary tree. The root node is a triangle labeled $(3,4,5)$. Three branches descend, each ending in a triangle drawn to scale and }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig06_descent_maze.png}
\captionof{figure}{A maze shaped like an inverted tree. At the bottom is a large glowing node labeled $(3,4,5)$. Many paths descend from a starting triple (e.g., $(119, 120, 169)$}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig07_factoring_trick.png}
\captionof{figure}{A visual "magic trick" layout. On the left, a card shows the number $667$ with a question mark. An arrow leads to a right triangle with legs $667$ and $156$ and}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig08_gnomon.png}
\captionof{figure}{A conceptual diagram showing the algebraic identity geometrically. A large square of side $c$ is partitioned: a square of side $b$ sits in one corner, and the r}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig09_b_branch.png}
\captionof{figure}{A number line or exponential growth chart showing the B-branch hypotenuses $5, 29, 169, 985, 5741, \ldots$ spaced on a logarithmic scale. Each point is connecte}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig10_euclid_grid.png}
\captionof{figure}{A two-dimensional grid with axes labeled $m$ and $n$. The region $m > n > 0$ is shaded. Lattice points are marked, and those corresponding to primitive triples }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig11_poincare_disk.png}
\captionof{figure}{The Poincaré disk, shown as a circle. Inside the disk, a tessellation of ideal hyperbolic triangles tiles the interior. Each triangular tile is labeled with a P}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig12_light_cones.png}
\captionof{figure}{Side-by-side comparison. LEFT: A Minkowski spacetime diagram showing a light cone in $2+1$ dimensions, with photon worldlines on the cone surface. RIGHT: The sa}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter1/images/fig13_wonder_map.png}
\captionof{figure}{A full-page "wonder map" --- a stylized infographic. At the center is the Berggren tree. Five radial arrows point outward to five surrounding vignettes: (1) A P}
\end{center}
