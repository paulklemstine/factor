\chapter*{The Triangle That Swallowed the Universe}
\index{Pythagoras}
\index{Euclid}
\index{Neugebauer, Otto}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Introduction/images/fig01_pythagorean_squares.png}
\captionof{figure}{A large, beautifully rendered depiction of a right triangle with legs labeled $a = 3$ and $b = 4$ and hypotenuse $c = 5$. On each side of the triangle, a perfec}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Introduction/images/fig02_primitive_triples_table.png}
\captionof{figure}{A table of the first sixteen primitive Pythagorean triples, organized in four columns. Column 1: the triple $(a, b, c)$ with $a$ odd and $b$ even. Column 2: the}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Introduction/images/fig03_bathroom_scene.png}
\captionof{figure}{A whimsical, full-page scene depicting a person sitting on the edge of a bathtub, staring at a bathroom floor tiled with white unit squares. On the floor, three}
\end{center}
