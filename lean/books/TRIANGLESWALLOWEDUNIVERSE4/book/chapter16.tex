...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig01_magic_box.png}
\captionof{figure}{A whimsical "magic box" diagram. Three labeled machines --- $A$, $B$, $C$ --- each drawn as brass-and-gear contraptions in a Victorian style, reminiscent of Bab}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig02_q_table.png}
\captionof{figure}{A small table showing 5 concrete numerical examples. Columns: "Original $(a,b,c)$", "$Q$", "Transformed $(a', b', c')$", "$Q'$". Each row shows a different trip}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig03_null_cone.png}
\captionof{figure}{A 3D rendering of the cone $a^2 + b^2 = c^2$ in $(a,b,c)$-space, viewed slightly from above and to the right. The cone opens upward along the positive $c$-axis.}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig04_berggren_tree.png}
\captionof{figure}{The first four levels of the Berggren tree, drawn as an elegant ternary tree diagram on cream paper. Root node: a small right triangle drawn to scale inside a c}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig05_minkowski_poincare.png}
\captionof{figure}{A side-by-side comparison. LEFT: A Minkowski spacetime diagram showing a light cone opening upward and downward from the origin, with two events marked on the u}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig06_elevator_descent.png}
\captionof{figure}{A vertical "elevator" diagram. The triple $(697, 696, 985)$ is at the top floor. At each floor below, an inverse Berggren matrix is applied (labeled with which }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig07_a_highway.png}
\captionof{figure}{A portion of the Berggren tree showing only the "A-highway" --- the leftmost branch at every generation, drawn as a long straight road receding into one-point p}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig08_prime_depth.png}
\captionof{figure}{A vertical number line on the left showing primes $5, 7, 11, 13, 17, 19, 23, 29, 31, \ldots$ in ascending order. Horizontal arrows of increasing length connect }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig09_factor_table.png}
\captionof{figure}{A "multiplication table" style grid. Rows labeled with the four small-factor divisors of $225$: $1, 3, 5, 9$. Columns labeled with their complementary large fac}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig10_triple_count.png}
\captionof{figure}{A bar chart showing $|T(N)|$ for $k = 1, 2, 3, 4, 5$ distinct odd prime factors. The bars grow exponentially: $1, 4, 13, 40, 121$. Each bar is decorated with ti}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig11_poincare_tessellation.png}
\captionof{figure}{A Poincaré disk tessellation in the spirit of Escher's \textit{Circle Limit III}. Instead of fish, each tile contains a right triangle with its side lengths pri}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter16/images/fig12_grand_diagram.png}
\captionof{figure}{A full-page "Grand Diagram." At the center, a right triangle labeled $(a, b, c)$ with a small square at the right angle and $Q = 0$ inscribed inside it. Radiati}
\end{center}
...
6. \textbf{★ (Challenge)} Show that the Berggren matrix $B$ satisfies $B^\top J B = J$, where $J = \text{diag}(1, 1, -1)$. *(This proves that $B$ is an element of the Lorentz group $O(2,1)$.)*
