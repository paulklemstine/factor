...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig01_quadruple_table.png}
\captionof{figure}{A beautifully arranged table of the first fifteen primitive Pythagorean quadruples (those with $\gcd(a,b,c,d)=1$), sorted by $d$, displayed inside a stylised fo}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig02_triangle_to_sphere.png}
\captionof{figure}{Side-by-side comparison. Left panel: a right triangle inscribed on a flat integer grid, legs $a$ and $b$, hypotenuse $c$, illustrating $a^2 + b^2 = c^2$. Right }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig03_bridge.png}
\captionof{figure}{A stone arch bridge spanning a river. On the left bank stands a translucent sphere labelled "$a^2 + b^2 + c^2 = d^2$" with the word "GEOMETRY" beneath. On the r}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig04_quadruple_machine.png}
\captionof{figure}{A vintage brass-and-mahogany mechanical device with four labelled input dials ($m$, $n$, $p$, $q$) on the left and four output displays ($a$, $b$, $c$, $d$) on }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig05_hypotenuse_decomposition.png}
\captionof{figure}{A number-line diagram showing $d$ as a single segment, decomposed into two coloured sub-segments: $m^2 + n^2$ (shaded blue) and $p^2 + q^2$ (shaded red). Each s}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig06_collision_roads.png}
\captionof{figure}{Two winding roads on a hilly landscape, each starting from a different village, converge on the same hilltop labelled $d^2 = 81$. The left road is marked with m}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig07_scaling_tetrahedra.png}
\captionof{figure}{A small tetrahedron with vertices labelled $(1, 2, 2, 3)$ sits beside a geometrically similar but three-times-larger tetrahedron labelled $(3, 6, 6, 9)$. Dotted}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig08_lattice_sphere.png}
\captionof{figure}{A three-dimensional integer lattice (a grid of dots in space) with a translucent sphere of radius $d$ centred at the origin. Two lattice points on the sphere ar}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig09_gaussian_plane.png}
\captionof{figure}{The complex plane with an integer grid. A vector from the origin to the point $(2, 3)$ is drawn boldly, representing the Gaussian integer $2 + 3i$. A square of }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig10_euclid_lever.png}
\captionof{figure}{An Archimedes-style lever diagram. A beam balances on a triangular fulcrum labelled "Euclid's Lemma." On the left end of the beam sits the product }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig11_mod4_grid.png}
\captionof{figure}{A $4 \times 4$ grid where rows represent values of $a^2 \bmod 4$ (labelled $0$ and $1$, repeating) and columns represent $b^2 \bmod 4$. Each cell contains two s}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig12_workbench.png}
\captionof{figure}{A mathematician's workbench scene. A wooden desk is strewn with papers showing the four showcase quadruples, pencil stubs, and a magnifying glass poised over th}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter12/images/fig13_histogram.png}
\captionof{figure}{A histogram (bar chart) showing the number of primitive Pythagorean quadruples for each value of $d$ from $1$ to $50$. Bars for prime values of $d$ are coloured}
\end{center}
