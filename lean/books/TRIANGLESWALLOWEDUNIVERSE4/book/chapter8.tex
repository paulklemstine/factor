...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig01_locksmith_tree.png}
\captionof{figure}{A tall, fantastical tree drawn in cross-section, with a tiny locksmith character at the top holding a magnifying glass labeled "$N$." The roots of the tree are }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig02_euclid_staircase.png}
\captionof{figure}{A descending staircase drawn on a grid, where each step represents one division in the Euclidean algorithm applied to $(377, 233)$. The width of each step is th}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig03_step_count_plot.png}
\captionof{figure}{A plot of "number of Euclidean algorithm steps" vs. "input size" for random pairs, shown as a cloud of scattered dots. The Fibonacci worst-case envelope is draw}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig04_danger_zone.png}
\captionof{figure}{A number line from $1$ to $N$, with $p$ and $q$ marked symmetrically around $\sqrt{N}$. Two cases are shown: (a) $p$ and $q$ far apart ("easy" --- the tree is s}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig05_nearly_square.png}
\captionof{figure}{A square of area $N = p \times q$, drawn as a nearly-square rectangle. The sides $p$ and $q$ are labeled. A perfect square $p \times p$ is shaded inside it, wit}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig06_gcd_node.png}
\captionof{figure}{A single node of the Pythagorean tree, drawn as a circle containing the triple $(a, b, c)$. An arrow leads from the node to a small box labeled "$\gcd(a, N)$." }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig07_descent_clocks.png}
\captionof{figure}{A tall tree with $\sqrt{N}$ levels, viewed from the side. At each level, a small clock icon shows the per-node cost "$\log N$." The total cost is displayed as a}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig08_multiplication_rect.png}
\captionof{figure}{A multiplication table--style grid. The vertical axis is labeled "Nodes: $O(\sqrt{N})$" and the horizontal axis "Cost per node: $O(\log N)$." The area of the re}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig09_complexity_vise.png}
\captionof{figure}{A vise or clamp squeezing a number from above and below. The upper jaw is labeled "$O(\sqrt{N})$" and the lower jaw "$\Omega(\sqrt{N})$." The number trapped bet}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig10_three_way_race.png}
\captionof{figure}{Three runners on a racetrack shaped like the number line from $2$ to $\sqrt{N}$. Runner A (Trial Division) starts at $2$ and runs right, checking every prime. R}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig11_comparison_table.png}
\captionof{figure}{A table comparing three factoring methods across three scenarios: (1) $p$ small, $q$ large (Trial Division wins); (2) $p \approx q$ (Fermat wins or ties); (3) G}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig12_dimensional_escape.png}
\captionof{figure}{A two-panel image. Left panel: a flat 2D maze with walls of height $\sqrt{N}$, and a tiny stick figure trapped inside, labeled "2D: $\Theta(\sqrt{N})$ steps." R}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig13_factoring_curves.png}
\captionof{figure}{A graph of $\log(\text{factoring time})$ vs. $\log N$. Three curves: (1) Trial division / Tree: a straight line with slope $1/2$ (labeled $\sqrt{N}$); (2) Quadr}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig14_quantum_descent.png}
\captionof{figure}{A vertical number line from depth $0$ to depth $\sqrt{N}$. A classical searcher descends step-by-step (each step drawn as a footprint). A quantum searcher, draw}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter8/images/fig15_full_recap.png}
\captionof{figure}{A full-page image recapitulating the chapter. A single tree dominates the center, rooted in the primes, with the semiprime $N$ as a glowing orb at the crown. Th}
\end{center}
