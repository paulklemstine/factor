...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig01_factory_tree.png}
\captionof{figure}{A sweeping binary tree diagram rooted at the node labeled $(2,1)$, with two branches at each node. The left branch is labeled "$\mathbf{M}_1$" and the right "}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig02_lattice_shear.png}
\captionof{figure}{Two side-by-side depictions of the integer lattice $\mathbb{Z}^2$. On the left, a unit square with vertices at $(0,0)$, $(1,0)$, $(0,1)$, $(1,1)$ is shown. On t}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig03_euclid_staircase.png}
\captionof{figure}{A step-by-step "descent staircase" diagram for the Euclidean algorithm applied to $(17, 5)$. Each step is drawn as a rectangular strip being peeled off a large }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig04_tree_vs_euclid.png}
\captionof{figure}{A split-screen diagram. On the left, a path descending through the Berggren tree from a node $(m, n) = (7, 2)$ back to the root $(2, 1)$, with each edge labeled}
\end{center}
...
\begin{displayquote}
\textbf{The Lattice-Tree Correspondence.} *Climbing down the Berggren tree --- applying $\mathbf{M}_3^{-1}$ and $\mathbf{M}_1^{-1}$ to return to the root --- computes precisely the same sequence of quotients as the Euclidean algorithm applied to the ratio $m/n$. The tree descent* is \textit{the continued fraction expansion.}
\end{displayquote}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig05_complexity_graph.png}
\captionof{figure}{A graph with $N$ on the horizontal axis (logarithmic scale) and "number of steps" on the vertical axis. Three curves are plotted: (1) the linear curve $N$ (labe}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig06_gauss_reduction.png}
\captionof{figure}{A two-dimensional integer lattice with basis vectors $\mathbf{v}_1$ and $\mathbf{v}_2$ drawn as arrows from the origin. The lattice points form a slanted grid. }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig07_2d_barrier.png}
\captionof{figure}{A dramatic conceptual image. A flat, two-dimensional plane stretches to the horizon, with a tiny figure (representing the mathematician) standing at the edge, p}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig08_lll_bargain.png}
\captionof{figure}{A three-dimensional lattice rendered in perspective, with a cloud of lattice points filling a cube. The true shortest vector is drawn in red (thin, hard to see)}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig09_quadruple_lattice.png}
\captionof{figure}{A three-dimensional coordinate system with axes labeled $x$, $y$, $z$. The surface $x^2 + y^2 + z^2 = N^2$ is drawn as a large sphere. Inside the sphere, intege}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter2/images/fig10_concept_map.png}
\captionof{figure}{A full-page "concept map" showing the logical flow of the chapter. At the top: "Berggren Tree" (with a small tree icon). An arrow labeled "inverse traversal" po}
\end{center}
