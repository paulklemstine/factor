...
\index{factoring}
\index{RSA cryptography}
\index{Euclid parametrization}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig01_rectangle_dissection.png}
\captionof{figure}{A $13 \times 5$ rectangle subdivided into unit squares. Two different L-shaped dissections highlighted in contrasting colors (one in warm amber, the other in co}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig02_gaussian_lattice.png}
\captionof{figure}{The Gaussian integer lattice $\mathbb{Z}[i]$ in the complex plane. Points $1+2i$ and $2+3i$ are shown as vectors from the origin, drawn in contrasting colors. T}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig03_triple_factory.png}
\captionof{figure}{A whimsical "Triple Factory" conveyor belt diagram. Two input conveyor belts enter from the left, one carrying a card labeled $(3, 4, 5)$ with a small right tri}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig04_multiplication_table.png}
\captionof{figure}{A multiplication table of small Pythagorean triples. Rows and columns are headed by $(3,4,5)$, $(5,12,13)$, $(8,15,17)$, and $(7,24,25)$. Each cell shows the co}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig05_euler_xray.png}
\captionof{figure}{"Euler's X-Ray Machine." A large number $N = 1105$ sits inside an ornate picture frame. On either side, two X-ray screens display the number's inner structure: }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig06_euler_portrait.png}
\captionof{figure}{A portrait sketch of Leonhard Euler at his desk, quill in hand, late in life (one eye clouded over). A thought bubble above his head contains the factoring iden}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig07_pythagorean_cone.png}
\captionof{figure}{A three-dimensional perspective drawing of the cone $x^2 + y^2 = z^2$ rising upward from the origin. The surface is translucent, revealing a grid of integer lat}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig08_light_cones.png}
\captionof{figure}{A side-by-side comparison. LEFT: A relativistic light cone in $2+1$ spacetime dimensions, with a photon worldline traced along the cone's surface and labels for}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig09_berggren_tree.png}
\captionof{figure}{A full ternary tree, three levels deep. The root node at the top contains $(3, 4, 5)$ with a small right triangle drawn to scale. Three branches descend, colore}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig10_tree_sieve.png}
\captionof{figure}{A stylized tree with thick trunk and spreading branches. Some branches bear glowing "fruit" --- small spheres labeled with divisor values. At the base of the tr}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig11_divisor_arcs.png}
\captionof{figure}{A number line showing $N^2 = 31861^2$ with tick marks at selected divisor pairs. Arcs connect complementary pairs $(c - b, c + b)$ that multiply to $N^2$. Stars}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig12_three_roads_map.png}
\captionof{figure}{A stylized map drawn in the manner of a medieval cartographer. Three winding roads converge on a fortified castle at the center, labeled "$p$ and $q$." Road 1, }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig13_exponential_climb.png}
\captionof{figure}{A vertical logarithmic scale running from $10^0$ at the bottom to $10^{20}$ at the top. The Berggren tree is drawn sideways, with the root at the left and branc}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig14_flower_diagram.png}
\captionof{figure}{A "flower" diagram. At the center, a circle contains $N^2$. Four petals radiate outward, each containing one sum-of-squares representation of $N^2$. The top two}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig15_factoring_toolkit.png}
\captionof{figure}{A "Pythagorean Factoring Toolkit" infographic divided into three columns. Column 1 (amber): "Euler's Two Portraits" --- the factoring identity, a worked example}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter4/images/fig16_road_ahead.png}
\captionof{figure}{A winding road receding into a misty distance. Mile markers along the road are labeled with the topics of future chapters: "Lattice Reduction" (Chapter 5), "Com}
\end{center}
