...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig01_tropical_calculator.png}
\captionof{figure}{A whimsical blueprint-style diagram of a calculator keypad. The "$+$" key is relabeled "$\min$" in tropical-orange ink, and the "$\times$" key is relabeled "$+$}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig02_distributive_shift.png}
\captionof{figure}{A number line running from $0$ to $15$. Two points are marked at $b = 7$ and $c = 2$, with an arc labeled "$\oplus$" pointing to $2$ (the minimum). Then the ent}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig03_totem_pole.png}
\captionof{figure}{A vertical "totem pole" of integers from $-3$ up to $+5$, with a cloud at the very top labeled "$\infty = $ tropical zero". An arrow from any integer $a$ to the}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig04_newton_polygon.png}
\captionof{figure}{A coordinate plane with horizontal axis labeled "exponent $i$" and vertical axis labeled "valuation $a_i$". Three points are plotted: $(0, 2)$, $(1, 7)$, }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig05_convex_hulls.png}
\captionof{figure}{Two side-by-side panels. LEFT: Classical convex hull --- a shaded triangle with vertices $A$, $B$, $C$ in $\mathbb{R}^2$, showing the line segment from $A$ to }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig06_triangle_inequality.png}
\captionof{figure}{Three cities ($x$, $y$, $z$) arranged on a road map, with roads of integer length connecting them. The direct road from $x$ to $z$ has length $d(x,z) = 5$, whil}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig07_tropical_matrix.png}
\captionof{figure}{A $4 \times 4$ weighted directed graph with cities labeled $A$, $B$, $C$, $D$. Edge weights are single-digit integers. Beside the graph, two $4 \times 4$ matric}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig08_bellman_ford.png}
\captionof{figure}{A five-vertex directed graph with source vertex $0$ at left. Arrows show edges with integer weights. Below the graph, a row of boxes showing $d(v)$ values after}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig09_book_map.png}
\captionof{figure}{A large "map of the book" diagram, drawn as a network graph. Each chapter is a node (labeled $1$ through $16$), and directed edges connect chapters whose concep}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter15/images/fig10_tropical_polynomial.png}
\captionof{figure}{A piecewise-linear graph of the tropical polynomial $p(x) = \min(3,\; 1+x,\; 4+2x)$, drawn on a standard $xy$-plane. Three line segments of different slopes mee}
\end{center}
