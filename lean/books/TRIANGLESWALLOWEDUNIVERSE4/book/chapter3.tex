...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig01_broken_square.png}
\captionof{figure}{A right triangle with legs labeled $21$ and $20$ and hypotenuse labeled $29$. On the leg of length $21$, a square of area $441$ is drawn. This square is visuall}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig02_factor_table.png}
\captionof{figure}{A table with six rows and six columns. The columns are labeled $a$, $b$, $c$, $c - b$, $c + b$, and "Revealed factors of $a$." The rows contain the Pythagorean }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig03_berggren_tree.png}
\captionof{figure}{An elegant ternary tree, drawn to resemble an actual tree with organic branching. The root node is a circle containing $(3,4,5)$. Three branches descend, labele}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig04_matrix_multiply.png}
\captionof{figure}{A "zoom-in" panel showing the explicit matrix-vector multiplication $B_2 \times (3, 4, 5)^\top = (21, 20, 29)^\top$. The multiplication is laid out step by step}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig05_light_cone.png}
\captionof{figure}{A three-dimensional coordinate system with axes labeled $a$, $b$, $c$. A double cone (the "light cone") defined by $a^2 + b^2 = c^2$ opens upward and downward f}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig06_photon_blackboard.png}
\captionof{figure}{A whimsical cartoon of a photon (depicted as a small glowing orb with googly eyes and a mortarboard cap) standing at a blackboard. On the blackboard is written }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig07_q_meter.png}
\captionof{figure}{A flow diagram. A vector $(a, b, c)$ enters a "black box" labeled $B_2$ from the left. Above the input, a circular gauge with a needle pointing to $0$ is labele}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig08_subway_map.png}
\captionof{figure}{A map-style diagram of the Berggren tree's first three levels, drawn as a road network or subway map. Each "station" (node) displays the triple on a signpost. E}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig09_wormhole.png}
\captionof{figure}{A visual "zoom" effect. On the left, the top of the Berggren tree is shown in full detail (three levels, all nodes visible). On the right, a telescope or "wormh}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig10_elevator.png}
\captionof{figure}{The Berggren tree from §2, but now with upward-pointing arrows drawn in a contrasting color (gold against the tree's green). The arrows are labeled $B_1^{-1}$, }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig11_lorentz_adjoint.png}
\captionof{figure}{A side-by-side display of $B_2$ and $B_2^{-1}$. Between them, the Lorentz adjoint formula $B_2^{-1} = \mathbf{Q}\, B_2^\top\, \mathbf{Q}$ is written in an elega}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig12_hypotenuse_bars.png}
\captionof{figure}{A bar chart with three groups of bars, one for each branch (Left, Middle, Right), showing the hypotenuses at levels 0 through 4. The Middle branch bars rocket u}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig13_chebyshev_line.png}
\captionof{figure}{A number line running horizontally across the page, with the middle-branch hypotenuses $5, 29, 169, 985, 5741$ marked at their positions (not to scale --- logar}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig14_three_subtrees.png}
\captionof{figure}{Three subtrees of the Berggren tree drawn side by side, one for each branch (Left in red, Middle in blue, Right in green). All three are rooted at the same pare}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig15_factoring_flowchart.png}
\captionof{figure}{A flowchart-style diagram, elegant and vertical. \textbf{Input box} at the top: "A composite number $N$." \textbf{Arrow down} to \textbf{Step 1}: "Find a Pythag}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig16_worked_example.png}
\captionof{figure}{The specific worked example for $(21, 20, 29)$, laid out as a visual "proof without words." At the top, the right triangle with sides $21$, $20$, $29$. Below it}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter3/images/fig17_concept_map.png}
\captionof{figure}{A full-page "map" of the chapter's conceptual landscape, drawn in the style of a medieval mappa mundi or a fantasy-novel treasure map. The map contains labeled }
\end{center}
