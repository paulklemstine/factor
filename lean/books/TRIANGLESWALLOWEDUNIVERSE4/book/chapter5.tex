...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig01_berggren_tree.png}
\captionof{figure}{A full ternary tree diagram, three levels deep, rooted at $(3,4,5)$. Each node is a circle containing a Pythagorean triple $(a, b, c)$. The three downward branc}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig02_three_triangles.png}
\captionof{figure}{Three right triangles drawn to scale: $(3,4,5)$, $(5,12,13)$, and $(15,8,17)$. Each triangle's sides are clearly labeled with lengths. Arrows indicate which Ber}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig03_null_cone.png}
\captionof{figure}{A three-dimensional coordinate system with axes labeled $a$, $b$, $c$. A cone (the "light cone") is drawn satisfying $a^2 + b^2 = c^2$, i.e., $Q = 0$. The cone }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig04_spacetime_comparison.png}
\captionof{figure}{Side-by-side comparison. LEFT: A classic spacetime diagram from physics, showing a light cone with two worldlines --- one timelike (inside the cone) and one spa}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig05_mirror_triangle.png}
\captionof{figure}{Two versions of a right triangle $(3,4,5)$, one the mirror image of the other (reflected across a vertical axis). The left triangle is labeled "proper" (}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig06_pythagorean_check.png}
\captionof{figure}{A segment of the Berggren tree (3 levels deep), with each node's triple displayed inside a circle. Alongside each triple, the values $a^2 + b^2$ and $c^2$ are c}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig07_null_cone_regions.png}
\captionof{figure}{The null cone $a^2 + b^2 = c^2$ in 3D, shown with the interior (timelike region, $Q < 0$) shaded in cool blue and the exterior (spacelike region, $Q > 0$) shade}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig08_factoring_vice.png}
\captionof{figure}{A "factoring vice" diagram. A large number $N^2$ sits in the center, rendered as a heavy block. Two arrows labeled $c - b$ and $c + b$ press in from both sides }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig09_brahmagupta_fibonacci.png}
\captionof{figure}{A visual proof of the Brahmagupta--Fibonacci identity using a rectangle subdivided into squares. A large rectangle has area $(a_1^2 + b_1^2)(a_2^2 + b_2^2)$. Th}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig10_euclid_grid.png}
\captionof{figure}{A grid of dots representing integer pairs $(m, n)$ with $m > n > 0$, arranged with $m$ on the horizontal axis and $n$ on the vertical. Dots satisfying }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig11_a_staircase.png}
\captionof{figure}{A vertical staircase drawn in side view (like an architectural cross-section), each step labeled with a Pythagorean triple. At the bottom: $(3, 4, 5)$ with labe}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig12_pell_number_line.png}
\captionof{figure}{A number line (logarithmic scale) showing the B-branch hypotenuses $5, 29, 169, 985, 5741$ at exponentially increasing intervals. Curved arrows between consecut}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig13_b_branch_vine.png}
\captionof{figure}{A single vertical "branch" of the Berggren tree --- the pure $B$-path, rendered as a vine growing upward. At each node (rendered as a leaf), the full triple }
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig14_grand_mosaic.png}
\captionof{figure}{A large, ornate diagram --- the "Grand Mosaic." At the center, a Pythagorean triple $(a, b, c)$ inscribed in a glowing right triangle. Radiating outward in eigh}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.85\textwidth]{/workspace/request-project/Chapter5/images/fig15_cheat_sheet.png}
\captionof{figure}{A full-page "cheat sheet" showing all eight theorem statements in clean mathematical typesetting, each numbered and titled. The layout is two columns, with gene}
\end{center}
