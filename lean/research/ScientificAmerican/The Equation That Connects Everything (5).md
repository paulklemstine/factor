...
The result: **8,471 verified theorems** across **334 source files** and **75,753 lines of code**, with **zero** unproven assertions. Every theorem has been certified by the kernel. The only axioms used are the three standard foundations of mathematics (propositional extensionality, the axiom of choice, and quotient soundness) — the same axioms underlying essentially all of modern mathematics.
...
After the build completes (allow 20-30 minutes for compilation), every one of the 8,471 theorems will be independently re-verified on your own machine. No trust required. No faith needed. Just mathematics.
...
| Machine-checked theorems & definitions | 8,471 |
