...
Pythagorean triples, establishing over 300 theorems spanning group theory,
analytic number theory, spectral graph theory, computational algebra, data
encoding, compression, and connections to the Riemann zeta function.  Our
...
(ix)~a ``Riemann zeta machine'' recovering 100/100 non-trivial zeta zeros from
...
codecs achieving 87.91$\times$ on financial data and lossless PPT wavelets
beating zlib by 2.18$\times$; and (xii)~the results of a comprehensive survey of
...
establishing over 300~theorems across group theory, analytic number theory,
spectral graph theory, continued fractions, elliptic curves, data encoding,
compression, and computational complexity.  The tree reveals a rich algebraic structure that simultaneously
